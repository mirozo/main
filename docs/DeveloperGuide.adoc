...
|`* * *` |secretary of NUS CCA |add details of interview eg. interviewer's name, interviewee's email |easily view the details of the interview
...
|`* * *` |secretary of NUS CCA |mark an interview as 'done' |track and manage uncompleted interviews
...
|`* *` |secretary of NUS CCA |share the current scheduled timeslot with another secretary |give them access to help with the scheduling of interviews as well
